...
/*
// Workfile:@(#)Cipher.java	1.21
// Version:1.21
// Date:05/03/02
// 
// Archive:  /Products/Europa/api21/javacardx/crypto/Cipher.java 
// Modified:05/03/02 16:39:02
...
abstract public class Cipher{
    ...
    /**
     * Cipher algorithm <code>ALG_RSA_ISO14888</code> provides a cipher using RSA.&nbsp;
     * Input data is padded according to the ISO 14888 scheme.
     */
    public static final byte ALG_RSA_ISO14888            = 9;

    /**
     * Cipher algorithm <code>ALG_RSA_PKCS1</code> provides a cipher using RSA.&nbsp;
     ...
     * ISO 9796 algorithm was withdrawn by ISO in July 2000.
     * @deprecated
     */
     ...
     * This algorithm does not pad input data. If the input data is bounded by incorrect
     ...
     * This algorithm does not pad input data. If the input data is not block
     * aligned it throws <code>CryptoException</code> with the reason code <code>ILLEGAL_USE</code>.
     */
   ...
   /**
     * Cipher algorithm <code>ALG_RSA_PKCS1_OAEP</code> provides a cipher using RSA.&nbsp;
     * Input data is padded according to the PKCS#1-OAEP scheme (IEEE 1361-2000).
     */
   ...
   /**
	...
	/**
         ...
         * ALG_ .. constants above e.g {@link #ALG_DES_CBC_NOPAD} 
     ...
     * does not pad the message and either the message is not block aligned or no input
