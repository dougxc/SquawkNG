/*
 * @(#)RecordStore.java 1.51 01/08/22
...
public class RecordStore
{
     ...
     * 12-15 - Reserved - Always nice to keep a few spare bits around
    ...
    private RecordStore(String recordStoreName, boolean create)
    ...
    try {
        dbraf = new RecordStoreFile(recordStoreName);
        /*
    ...
    synchronized (dbCacheLock) {
        ...
        /*
         * Record store not found in cache. Check
         * for space and create it.
         */
    ...
    synchronized (rsLock) {
         ...
         * A linear search is OK assuming there won't be many
