 ...
 * The coordinate system is such that the points along horizontal
 * axis increase in value from left to right, and points along
 * the vertical axis increase in value from top to bottom.
 */
...
/*========================================================*/
    ...
    /**
     * There is only ever one Graphics object in the system, and
     ...
     * @param mode the drawing mode to use (one of
     *        <code>PLAIN, GRAY, ERASE</code> or <code>INSERT</code>.
     */
     ...
     * @param mode the drawing mode to use (one of
     *        <code>PLAIN, GRAY, ERASE</code> or <code>INSERT</code>.
     * @param cornerDiam the diameter of four imaginary circles used to
     * form the rounded corners. An imaginary circle is placed within
     * each corner tangent to the rectangle on two sides.
     */
    public static /*native*/ void drawRectangle(int left, int top, int width, int height, int mode, int cornerDiam) {
        throw new Error("Unimplemeted native method");
    }
     ...
     * @param mode the drawing mode to use (one of
     *        <code>PLAIN, GRAY, ERASE</code> or <code>INSERT</code>.
     * @param frameType one of <code>SIMPLE</code>, <code>RAISED</code> or
     *        a type constructed by a call to <code>borderType</code>.
     */
    public static /*native*/ void drawBorder(int left, int top, int width, int height, int mode, int frameType) {
        throw new Error("Unimplemeted native method");
    }
     ...
     * @param mode the drawing mode to use (one of
     *        <code>PLAIN, RAY, ERASE</code> or <code>INVERT</code>.
     ...
     */
     public /*native*/ static void setDrawRegion(int left, int top, int width, int height) {
        throw new Error("Unimplemeted native method");
    }
     ...
     */
    public /*native*/ static void copyRegion(int left, int top, int width, int height, int dstX, int dstY, int mode) {
        throw new Error("Unimplemeted native method");
    }
     ...
     */
    public /*native*/ static void copyOffScreenRegion(int left, int top, int width, int height, int dstX, int dstY, int mode, int srcWind, int dstWind) {
        throw new Error("Unimplemeted native method");
    }
     ...
     * Play a sound.
     *
     * @param freq is a frequency in Hz
     * @param duration is a duration in millisecs
     * @param volume is a volume in 0..127
     */
    public /*native*/ static void playSoundHz(int freq, int duration, int volume) {
        throw new Error("Unimplemeted native method");
    }
     ...
     * Plays a MIDI file.
     *
     * @param midifile is byte sequence of MIDI data
     */
    public /*native*/ static void playSMF(byte[] midifile) {
        throw new Error("Unimplemeted native method");
    }
