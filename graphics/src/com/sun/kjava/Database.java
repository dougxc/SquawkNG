 ...
 *=======================================================================*/
         ...
         */
        public static /*native*/ boolean create(int cardNo, String name, int creatorID, int typeID, boolean resDB) {
 ...
 *=======================================================================*/
         ...
         */
        public /*native*/ int readRecordToBuffer(int recordNumber, int readOffset, int length, byte[] buffer, int writeOffset) {
            throw new Error("Unimplemeted native method");
        }
         ...
         * Currently unimplemented.
         */
        public /*native*/ int writeRecordFromBuffer(int recordNumber, int writeOffset, int length, byte[] buffer, int readOffset) {
            throw new Error("Unimplemeted native method");
        }
