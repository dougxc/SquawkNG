...
//    private static final long serialVersionUID = 7997698588986878753L;
     ...
     * @exception IllegalArgumentException if the specified initial size
     *               is negative.
     */
...
//    }
   ...
   /* ------------------------------------------------------------------------- *\
    *         Routines to pickle/unpickle bitsets into/from byte arrays.        *
   \* ------------------------------------------------------------------------- */

   /**
    * Pickle this bit set into a byte array. This only serializes as much
    * of the bit set as can fit into the given array. This method assumes
    * that bytes is a zero'ed non-null array.
    * @param bytes the array to pickle into.
    */
    public void toByteArray(byte[] bytes) {
    ...
    /**
     * Unpickle a byte array into a BitSet. This is the analogue of the toByteArray method.
     * @param bytes the array contained a pickled bit set.
     */
