 ...
 *
 *   GOPFormatException.java   1999-2-24 09:11 am
 *
...
/**
 *   Format Exception in GOP layer
 */
class GOPFormatException extends SequenceFormatException
{
    GOPFormatException()
    {
        super();
