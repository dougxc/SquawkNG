...
//Trace.println("getPicture() 3");

        // Extra Information Picture
        while (stream.showBits(1)==1)
            stream.flushBits(9);
//Trace.println("getPicture() 4");
