...
//  public Variable output() { return direction==forward ? v2 : v1; }
  public Variable output() { if (direction==forward) return v2; return v1; }


  // Answer my current input variable
  //public Variable input() { return direction==forward ? v1 : v2; }
  public Variable input() { if (direction==forward) return v1; return v2; }
...
public class DeltaBlue {
  ...
  public void inst_main(String args[])
  {
    ...
    inst_main(iterations);
  }

  public void inst_main(int iterations)
  {
  ...
  private void projectionTest(int n)
  {
    ...
    for (int i= 0; i < n; ++i) {
      src= new Variable(/*"src" + Integer.toString(i)*/null, i);
      dst= new Variable(/*"dst" + Integer.toString(i)*/null, i);
