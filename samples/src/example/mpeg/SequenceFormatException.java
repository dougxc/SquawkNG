 ...
 *
 *   SequenceFormatException.java   1999-2-24 09:11 am
 *
...
/**
 *   Format Exception in video sequence
 */
class SequenceFormatException extends Exception
{
    ...
    SequenceFormatException(String s)
    {
        super(s);
    }
}
