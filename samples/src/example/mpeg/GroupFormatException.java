 ...
 *
 *   GroupFormatException.java   1999-2-24 09:11 am
 *
...
/**
 *   Format Exception in Group layer
 */
class GroupFormatException extends PacketFormatException
{
    public GroupFormatException()
    {
        super();
    }

    public GroupFormatException(String s)
    {
        super(s);
    }
}
